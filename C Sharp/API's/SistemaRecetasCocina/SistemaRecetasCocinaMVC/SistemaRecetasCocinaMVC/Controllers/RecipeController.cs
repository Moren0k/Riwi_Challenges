...
using SistemaRecetasCocinaMVC.Data;
using SistemaRecetasCocinaMVC.Models;

namespace SistemaRecetasCocinaMVC.Controllers;
...
public class RecipeController : Controller
{
    ...
    private static async Task<MealResponse?> GetRecipesAsync(string name)
    {
        ...
        return JsonSerializer.Deserialize<MealResponse>(response, options);
    }
}